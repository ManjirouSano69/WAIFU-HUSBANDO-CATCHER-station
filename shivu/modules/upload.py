...
rarity_map = 1 (⚪️ Common), 2 (🟢 Medium) , 3 (🟠 Rare), 4 (🟡 Legendary), 5 (💠 Exclusive), 6 (🔮 Limited Edition)"""
...
async def upload(update: Update, context: CallbackContext) -> None:
    ...
    try:
        ...
        rarity_map = {1: "⚪ Common", 2: "🟢 Medium", 3: "🟠 Rare", 4: "🟡 Legendary", 5: "💠 Exclusive", 6: "🔮 Limited Edition"}
        try:
