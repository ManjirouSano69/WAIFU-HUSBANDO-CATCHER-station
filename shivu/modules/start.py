...
*Tᴏ ɢʀᴀʙ ᴛʜᴇsᴇ ᴇɴᴄʜᴀɴᴛɪɴɢ ᴡᴀɪғᴜs, sɪᴍᴘʟʏ ᴜsᴇ ᴛʜᴇ ᴄᴏᴍᴍᴀɴᴅ /grab <ᴡᴀɪғᴜ ɴᴀᴍᴇ>. Aɴᴅ ᴛʜᴀᴛ's ɴᴏᴛ ᴀʟʟ! Yᴏᴜ ᴄᴀɴ ᴋᴇᴇᴘ ᴛʀᴀᴄᴋ ᴏғ ʏᴏᴜʀ ʜᴀʀᴇᴍ ʙʏ ᴜsɪɴɢ ᴛʜᴇ ᴄᴏᴍᴍᴀɴᴅs /harem ᴏʀ /collection. 🌸*
...
*/grab: Tᴏ ɢʀᴀʙ Wᴀɪғᴜ (ᴏɴʟʏ ᴡᴏʀᴋs ɪɴ ɢʀᴏᴜᴘs)*
